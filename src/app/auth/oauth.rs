...
impl OAuth {
    ...
    pub async fn create_state(&self, state: OAuthState) -> Result<Id, sqlx::Error> {
        sqlx::query(
    ...
    pub async fn get_state_by_csrf_token(
        &self,
        csrf_token: &str,
    ...
    pub async fn delete_state_by_csrf_token(&self, csrf_token: &str) -> Result<(), sqlx::Error> {
    ...
    pub async fn sync_account(&self, info: OAuthAccountInfo) -> Result<User, sqlx::Error> {
